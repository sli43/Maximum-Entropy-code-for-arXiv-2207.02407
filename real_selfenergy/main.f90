...
double precision:: debaifreq=10.0d0
double precision:: m0=0.15d0

integer,parameter::num_alpha=60
double precision,parameter::alphamin=-2.0d0
double precision,parameter::alphamax=1.5d0
...
print*, "=============================================="
print*, "Maximum Entropy method to calculate the Eliashberg function from the real part of the self-energy"
...
use cluster, only: num_w, freq, spec_default, m0, debaifreq
implicit none
integer i, j
